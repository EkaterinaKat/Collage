...
class Controller implements FxController {
    ...
    private void initialize() {
        Collage collage = new CollageBuilder()
                ...
                .allExistingImages(Arrays.asList("/images/3.png", "/images/4.jpg", "/images/5.png", "/images/6.jpg",
                        "/images/7.png", "/images/8.jpg", "/images/9.jpg", "/images/10.jpg", "/images/11.jpg",
                        "/images/12.jpg", "/images/13.jpg", "/images/14.png", "/images/15.png", "/images/16.png",
                        "/images/17.jpg"))
                .build();
